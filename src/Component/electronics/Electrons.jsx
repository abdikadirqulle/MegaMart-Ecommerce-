...
const Electrons = () => {
  return (
    <div className="flex flex-col md:flex-row  gap-4">
      {/* Iphone */}
      <div className="w-[389px] h-[207px] rounded-[16px] relative overflow-hidden bg-[#313131]">
      ...
      {/* RealMe */}
      <div className="w-[389px] h-[207px] rounded-[16px] relative overflow-hidden bg-[#FFF3CC]">
      ...
      {/* xiaomi */}
      <div className="w-[389px] h-[207px] rounded-[16px] relative overflow-hidden bg-[#FFECDF]">
