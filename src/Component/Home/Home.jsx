...
const Home = () => {
  return (
    <div className="max-w-6xl mx-auto h-[316px] bg-[#202844]  rounded-2xl relative">
      <div className="flex justify-between items-center h-full relative overflow-hidden  rounded-2xl px-4 md:px-[2rem] lg:px-[5rem]">
        <div className=" flex flex-col space-y-2 pt-9 z-40 h-full relative">
          ...
          <div className="flex gap-4 items-center absolute bottom-4 lg:bottom-12 left-1  cursor-pointer text-White">
      ...
      absolute top-[110px] -left-10 hidden xl:flex
      border-8 border-solid border-White items-center justify-center "
      >
      ...
      border-8 border-solid border-White items-center justify-center hidden xl:flex"
      >
